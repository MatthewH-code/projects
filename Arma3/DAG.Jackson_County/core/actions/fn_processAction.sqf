...
_itemInfo = switch (_type) do
{
	...
	case "meth": {["methu","methp",5000,"Packaging Meth"];};
	case "MDMA": {["MDMAu","MDMAp",5000,"Pill Pressing MDMA"];};
	case "coke": {["cokeu","cokep",5000,"Packaging Cocaine"];};
	case "dagwood": {["wood","laminate",2850, (localize "STR_Process_Laminate")];};
	default {[];};
};
