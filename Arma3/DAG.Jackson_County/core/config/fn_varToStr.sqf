...
switch (_var) do
{
	...
	case "life_inv_BigMac": {"Big Mac Burger"};
	...
	case "life_inv_cleankit": {"KaelKlean"};
	...
	case "life_inv_laminate": {(localize "STR_Item_laminate")};
	...
	case "life_inv_feedbackstears": {"Feedbacks's Tears"};
	...
	case "license_cop_admin": {(localize "STR_License_Admin")};
	...
	case "license_civ_dagwood": {(localize "STR_License_Dagwood")};
};
