...
switch (_side) do
{
	...
	{
		_return = [
			["cop_spawn_1","Jackson SO","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
			["cop_spawn_2","Morrison Town SO","\a3\ui_f\data\map\MapControl\fuelstation_ca.paa"],			
			["cop_spawn_3","Los Diablos","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],			
	...
	case civilian:
	{
		...
		_return = [
			["civ_spawn_1","Jackson","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
    ...
    case independent: {
		_return = [
			["medic_spawn_2","Jackson HQ","\a3\ui_f\data\map\MapControl\hospital_ca.paa"],
