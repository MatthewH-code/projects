...
switch (_var) do
{
	...
	case "life_inv_axe": {("icons\items\pickaxe.paa")};	
	...
	case "life_inv_vehiclecharge": {("icons\items\blastingcharge.paa")};
	...
	case "life_inv_idcard": {("icons\items\blastingcharge.paa")};
	case "life_inv_blastingcharge": {("icons\items\blastingcharge.paa")};
	case "life_inv_vehiclecharge": {("icons\items\blastingcharge.paa")};
	case "life_inv_zipties": {("icons\items\lockpick.paa")};
};
