...
if (typeOf cursorTarget IN ["critgamin_vangmcc_clothing","critgamin_vangmcc_fedex","critgamin_vangmcc_food","critgamin_vangmcc_general"]) exitwith
{
	...
	life_atmcash = life_atmcash + 2222;
	hint "You were paid $2222 for impounding this vehicle";
};
...
if((getPlayerUID player) == _vehOwner) exitWith { hint "You can not impound your own vehicle."; };
